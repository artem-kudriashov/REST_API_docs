...
| options                                                | array [options](get-product.md#options)                            | <p>Detailed list of product options. <br><br>Empty (<code>[]</code>) if no options are specified for the product.</p>                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| nameTranslated | object [translations](get-product.md#translations) | Available translations for the category name. |
