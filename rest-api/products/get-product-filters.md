...
<table><thead><tr><th width="120.36328125">Field</th><th width="97">Type</th><th>Description</th></tr></thead><tbody><tr><td>filterFields</td><td>string</td><td><p>String that defines all applied filtering params, for example: <code>"price,inventory,option_Size,attribute_Brand,categories"</code>.<br><br>Full list of supported filters: </p><p><code>"price"</code></p><p><code>"inventory"</code></p><p><code>"onsale"</code></p><p><code>"categories"</code></p><p><code>"option_{optionName}"</code></p><p><code>"attribute_{attributeName}"</code><br><br>If an option/attribute has a comma or a backslash in its name, escape it with a backslash  <code>\</code>. <br><br>For example, an option named <code>"Color, size"</code> transforms to <code>"option_Color\, size"</code> in the request.</p></td></tr></tbody></table>
