...
```http
GET /api/v3/1003/products/692730761/combinations HTTP/1.1
...
| alt                                  | object [alt](search-product-variations.md#alt)                                   | Image description for the "alt" HTML attribute and its translations.                                                                                                                                                                                                                                                                                                                                                                                        |
...
| nameTranslated  | object [translations](search-product-variations.md#translations) | Available translations for the product option name.  |
| value           | string                                                           | Value of the selected option.                        |
| valueTranslated | object [translations](search-product-variations.md#translations) | Available translations for the product option value. |
