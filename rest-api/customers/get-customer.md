...
| billingPerson     | object [billingPerson](get-customer.md#billingperson)                   | Customer's billing name/address.                                                                                                                                                                                                          |
| shippingAddresses | array of objects [shippingAddresses](get-customer.md#shippingaddresses) | List of saved shipping addresses for the customer.                                                                                                                                                                                        |
| contacts          | array of objects [contacts](get-customer.md#contacts)                   | Customer's contact information: email, phone, social media links.                                                                                                                                                                         |
...
| stats             | object [stats](get-customer.md#stats)                                   | Customer's sales stats: number of orders, total revenue, first order date, etc.                                                                                                                                                           |
| privateAdminNotes | string                                                                  | Personal notes about the customer. Visible only to the store owner.                                                                                                                                                                       |
| favorites         | array of objects [favorites](get-customer.md#favorites)                 | List of customer's favorite products.                                                                                                                                                                                                     |
