...
| shortDescriptionTranslated | object [translations](create-order.md#translations)       | Available translations for product short description.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| nameTranslated             | object [translations](create-order.md#translations)       | Available translations for the product name.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| selectedOptions            | array [selectedOptions](create-order.md#selectedoptions)  | Product options values selected by the customer at the checkout.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| taxes                      | array [taxes](create-order.md#taxes)                      | Detailed information about taxes applied to the product in this order.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| dimensions                 | object [dimensions](create-order.md#dimensions)           | Details about product dimensions used for shipping costs calculations.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| discounts                  | array [discounts](create-order.md#discounts)              | **Promotions** applied to the specific product in the order.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| taxesOnShipping            | array [taxesOnShipping](create-order.md#taxesonshipping)  | <p>Taxes applied to shipping costs for the product with the calculation formula of: <code>(shippingRate + handlingFee)*(taxValue/100)</code></p><p><br>If the order is manually updated after being placed, this field is not recalculated automatically.</p>                                                                                                                                                                                                                                                                                                                                                       |
...
| attributes                 | array of objects [attributes](create-order.md#attributes) | <p>Details about product attributes.<br><br>Read more on product attributes in <a href="https://support.ecwid.com/hc/en-us/articles/207807495-Product-types-and-attributes">Help Center</a>.</p>                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| taxes                 | array [taxes](create-order.md#taxes) | Details about taxes applied to the surcharge.                                                                                                                                              |

#### discounts

| Field        | Type                                                          | Description                                          |
| ------------ | ------------------------------------------------------------- | ---------------------------------------------------- |
| discountInfo | array of objects [discountInfo](create-order.md#discountinfo) | Details about **promotions** applied to the product. |
...
| catalogLimit     | object [catalogLimit](create-order.md#cataloglimit) | Products and categories the coupon can be applied to                                                                                                                             |
...
| shipTo          | object [shippingPerson](create-order.md#shippingperson)   | Name and address of the person entered in shipping information.                    |
| shipFrom        | object [shipFrom](create-order.md#shipfrom)               | Shipping origin address. If matches company address, company address is returned.  |
| parcel          | object [parcel](create-order.md#parcel)                   | Information about the selected package to ship items to customer.                  |
| shippingService | object [shippingService](create-order.md#shippingservice) | Selected shipping service.                                                         |
| tracking        | object [tracking](create-order.md#tracking)               | Tracking details provided by shipping service.                                     |
| shippingLabel   | object [shippingLabel](create-order.md#shippinglabel)     | Shipping label details.                                                            |
