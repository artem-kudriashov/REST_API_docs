...
| favoriteProductsReminder    | Object [MailNotificationsSettings](update-store-profile.md#mailnotificationssettings) | Settings for `Order status changed` emails. Supported settings: `enabled`, `discountCouponId`                        |
